...
public class MergeContactXML {
	...
	public String MergeContact(String match1,String match2,String commandDetail)
	{
		try {
	...
	public String MergeIterator(Element element)
	{
